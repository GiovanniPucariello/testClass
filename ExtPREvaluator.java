...
public class ExtPREvaluator extends BasicEvaluator implements Evaluator {
    ...
    public void forC2inS2(URI uri1,Cell c1, Cell c2) throws OntowrapException {
    ...
    public void ifS2NotNull(Set<Cell> s2,URI uri1, Cell c1) throws OntowrapException {

        for (Cell c2 : s2) {

            this.forC2inS2(uri1,c1,c2);
        }
    ...
    public void ifNbFoundNbexpeted(){
    ...
    public void ifNbfoundnbexpected(){
    ...
    public double eval(Properties params, Object cache) throws AlignmentException {
        ...
        this.ifNbFoundNbexpeted();
        this.ifNbfoundnbexpected();
        this.ifNb();
    ...
    public void ifRelensitive(Cell c1, Cell c2,double val){
    ...
    public void ifElseOnto1(Cell c1, int val1, Cell c2) throws OntowrapException, AlignmentException {
    ...
    public void ifElseOnto2(int val2, Cell c1, Cell c2) throws OntowrapException, AlignmentException {
    ...
    public void forC2Align2(Cell c1, Cell c2, double sim) throws AlignmentException, OntowrapException {

        int val1 = 0; // the similatity between the o1 objects
        int val2 = 0; // the similarity between the o2 objects

        this.ifElseOnto1(c1,val1,c2);

        this.ifElseOnto2(val2,c1,c2);
    ...
    protected double computeEffSimilarity(Cell c1, Alignment s2) {
        ...
        try {
            for (Cell c2 : align2) {
                this.forC2Align2Compute(c1,c2,sim);
            }
        } catch (OntowrapException aex) {
            return 0;
        } catch (AlignmentException aex) {
    ...
    public void elseOnto1(int val1, Cell c1, Cell c2, double val) throws AlignmentException {
    ...
    public void elseOnto2(int val2, Cell c1, Cell c2, double val) throws AlignmentException {
    ...
    public void ifC1(Cell c1, Cell c2, double val,double sim){
    ...
    public void forC2Align2Compute(Cell c1, Cell c2, double sim) throws OntowrapException, AlignmentException {
        ...
        if (onto1.getEntityURI(c1.getObject1()).equals(onto1.getEntityURI(c2.getObject1()))) {
            ...
            this.elseOnto1(val1,c1,c2,val);
        }
        if (onto2.getEntityURI(c1.getObject2()).equals(onto2.getEntityURI(c2.getObject2()))) {
            // val remains val
        } else {
            this.elseOnto2(val2,c1,c2,val);
        }
        this.ifC1(c1,c2,val,sim);
    }
    ...
    protected double computePrecisionOrientedSimilarity(Cell c1, Alignment s2) {
        ...
        try {
            for (Cell c2 : align2) {
                ...
                this.ifElseOnto1Precision(c1,c2,val,val1);

                this.ifElseOnto2Precision(c1,c2,val2,val);

                this.ifWithConfidenceRelsensitive(val,c1,c2);
    ...
    public void elseOnto2Precision(int val2, double val, Cell c1, Cell c2) throws AlignmentException {
    ...
    public void ifWithConfidenceRelsensitive(double val, Cell c1, Cell c2){
        if (withConfidence) val *= 1. - Math.abs(c1.getStrength() - c2.getStrength());
        // Here the measure should also take into account relations
        if (relsensitive && !c1.getRelation().equals(c2.getRelation())) {
            this.ifRelsensitiveC1C2(c1,c2,val);
        }
    }

    public void ifElseOnto1Precision(Cell c1, Cell c2, double val, int val1) throws OntowrapException, AlignmentException {
        if (onto1.getEntityURI(c1.getObject1()).equals(onto1.getEntityURI(c2.getObject1()))) {
            val = 1.;
        } else {
            this.elseOnto1Precision(val1,val,c1,c2);
        }
    }

    public void ifElseOnto2Precision(Cell c1, Cell c2, int val2 ,double val) throws OntowrapException, AlignmentException {
        if (onto2.getEntityURI(c1.getObject2()).equals(onto2.getEntityURI(c2.getObject2()))) {
            // val remains val
        } else {
            this.elseOnto2Precision(val2,val,c1,c2);
        }
    }
    ...
    protected double computeRecallOrientedSimilarity(Cell c1, Alignment s2) {
        ...
        try {
            for (Cell c2 : align2) {
                this.forC2Align2Recall(c1,c2,sim);
            }
        } catch (OntowrapException aex) {
            return 0;
        } catch (AlignmentException aex) {
    ...
    public void elseOnto1Recall(int val1, double val , Cell c1, Cell c2) throws AlignmentException {
        val1 = relativePosition(c1.getObject1(), c2.getObject1(), onto1);
    ...
    public void elseOnto2Recall(int val2, double val, Cell c1, Cell c2) throws AlignmentException {
    ...
    public void ifWithConfidenceRelsensitiveRecall(double val, Cell c1, Cell c2){
        ...
        // Here the measure should also take into account relations
        if (relsensitive && !c1.getRelation().equals(c2.getRelation())) {
            this.ifRelsensitiveRecall(c1,c2,val);
        }
    }

    public void forC2Align2Recall(Cell c1, Cell c2, double sim) throws OntowrapException, AlignmentException {
        ...
        if (onto1.getEntityURI(c1.getObject1()).equals(onto1.getEntityURI(c2.getObject1()))) {
            ...
            this.elseOnto1Recall(val1,val,c1,c2);
        }
        if (onto2.getEntityURI(c1.getObject2()).equals(onto2.getEntityURI(c2.getObject2()))) {
            // val remains val
        } else {
            this.elseOnto2Recall(val2,val,c1,c2);
        }

        this.ifWithConfidenceRelsensitiveRecall(val,c1,c2);
